...
public class HotelOwnerInfoDetails  implements UserDetails{
	
	private String username;
    private String password;
    private List<GrantedAuthority> authorities;

    public HotelOwnerInfoDetails(HotelOwner hotelOwner) {
        username=hotelOwner.getUsername();
        password=hotelOwner.getPassword();
        authorities= Arrays.stream(hotelOwner.getRole().split(","))
